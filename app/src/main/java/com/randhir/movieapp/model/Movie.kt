package com.randhir.movieapp.model

// We will get all this data from json file(our data source) - a format to represent data as objects
data class Movie(val id: String , val title: String , val year: String ,
                val genre: String , val director: String , val actors: String,
                val plot: String, val poster: String , val images: List<String>,
                val rating: String)

// Here we are passing data locally , not from the web - this data is copied from a json file
